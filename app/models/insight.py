...
class InsightFinboxFeatures(BaseModel):
    ...
    mf_trx_recency: Optional[str] = Field(None, description="Recency of latest MF transaction.")
    ...
    fd_trx_recency: Optional[str] = Field(None, description="Recency of latest FD transaction.")
    ...
    sip_trx_recency: Optional[str] = Field(None, description="Recency of latest SIP transaction.")
